...
insert into users (first_name, last_name, email, password, family_id, address_id, active) values ('Chris','Crawford','chriscrawford86@gmail.com', 'parsnips',(select id from family where name='Crawford'),(select id from addresses where address_line_1='8 Rathmoyle Park West'),1);
...
insert into users (first_name, last_name, email, password, family_id, address_id, active) values ('Marylyn','Crawford','marylyncrawford60@gmail.com', 'carrots',(select id from family where name='Crawford'),(select id from addresses where address_line_1='5 Bluefield way'),1);
...
insert into users (first_name, last_name, email, password, family_id, address_id,active) values ('Luca','Crawford','lucacrawford20@gmail.com', 'herbs',(select id from family where name='Crawford'),(select id from addresses where address_line_1='8 Rathmoyle Park West'),1);
