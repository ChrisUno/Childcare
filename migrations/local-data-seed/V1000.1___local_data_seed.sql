...
insert into users (first_name, last_name, email, password, /* family_id, address_id, */ active) values ('Chris','Crawford','chriscrawford86@gmail.com', '$2a$11$PyvxC.XWkw39CTjel7FGo.adM8gJnW5YFSSQsrWF/T93fR.H46MQK',/* (select id from family where name='Crawford'),(select id from addresses where address_line_1='8 Rathmoyle Park West'), */TRUE);
